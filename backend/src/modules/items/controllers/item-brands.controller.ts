...
import { ItemBrandsService } from "@/modules/items/services/item-brands.service";
...
export class ItemBrandsController {
  ...
  @ApiCreateOk()
  @Permissions("item-brands:create")
  ...
  @ApiMutationOk()
  @Permissions("item-brands:update")
  ...
  @ApiParam({ name: "code", example: "BR-01" })
  @ApiDeleteOk()
  @Permissions("item-brands:delete")
